    ...
    <div className="min-h-screen bg-slate-950 text-white selection:bg-purple-500/30">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-[40%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-blue-600/10 rounded-full blur-[150px]" />
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-sm font-medium text-slate-300">Live Monitoring Active</span>
            </motion.div>
            ...
            >
              <Link 
                href="/register"
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
              >
                Start Monitoring <ArrowRight className="w-4 h-4" />
              </Link>
              <Link 
                href="#how-it-works"
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-semibold hover:bg-white/10 backdrop-blur-sm transition-all duration-300"
              >
                How it Works
              </Link>
            </motion.div>
      ...
      <section id="features" className="py-24 relative">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Why BnBAlerts?</h2>
            <p className="text-slate-400 text-lg">Engineered for speed, reliability, and success.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-6 shadow-lg`}>
                  {feature.icon}
                </div>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex gap-6">
                    <div className="text-2xl font-bold text-slate-700 font-mono">{item.step}</div>
                    <div>
            ...
            <div className="flex-1 relative">
              ...
              <div className="relative bg-slate-950 border border-white/10 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4">
                  ...
                  <div className="text-xs text-slate-500 font-mono">bnb-alerts-engine.exe</div>
                </div>
                ...
                <div className="space-y-4 font-mono text-sm">
                  ...
                  <div className="pl-6 text-slate-500">
                    [14:02:31] Checking Property #84920... <span className="text-red-400">Booked</span>
                  </div>
                  <div className="pl-6 text-slate-500">
                    [14:02:32] Checking Property #19384... <span className="text-red-400">Booked</span>
                  </div>
                  <div className="pl-6 text-slate-300">
                    [14:02:33] Checking Property #99281... <span className="text-green-400 font-bold">AVAILABLE!</span>
                  </div>
                  <div className="p-3 bg-green-500/10 border border-green-500/20 rounded text-green-300 mt-2 animate-pulse">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-8">Ready to secure your stay?</h2>
          <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
            Join thousands of travelers who stopped searching and started booking.
          </p>
          <Link 
            href="/register"
            className="inline-flex items-center gap-2 px-10 py-5 rounded-full bg-white text-slate-950 font-bold text-lg hover:bg-slate-200 transition-colors shadow-xl shadow-white/10"
          >
